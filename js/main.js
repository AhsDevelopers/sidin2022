...
(() => {
    const app = {
      initialize() {
        ...
        console.log('Zin om een goede programmeur te worden? Bekijk dan op zeker onze opleidingen:');
        console.log('Bachelor New Media Development');
        console.log('Graduaat Programmeren');
